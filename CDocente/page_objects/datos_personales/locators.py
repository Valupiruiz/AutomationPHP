...
class DatosPersonalesLocators:
    ...
    CUIL_INP = Locator(By.XPATH, "docente_cuil")
    ...
    AGREGAR_IMAGEN_DNI_BTN = Locator(By.XPATH, "//div[@class='controls dni']//button[@class='btn btn-primary btn-subir'][contains(text(),'Agregar')]")
    CELULAR_INP = Locator(By.ID, "docente_celular")
    RECIBE_JUB_FALSE = Locator(By.ID, "docente_tiene_beneficio_jubilatorio_0")
    TERM_CHECK = Locator(By.ID, "readConfirm_t")
    ACEPTO_BTN = Locator(By.XPATH, "//input[@value='Acepto']")