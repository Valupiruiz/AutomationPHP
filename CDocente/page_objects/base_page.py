...
class BasePage:
    ...
    def move_to_element(self,  locator: "Locator", timeout: int = _DEFAULT_TIMEOUT):
        """
        Encuentra el elemento definido por locator, lo espera, y mueve el mouse hasta este
         Args:
            locator (Locator): objeto que abstrae el elemento a encontrar
            timeout (int): cantidad máxima de tiempo a esperar antes de lanzar una excepción
        """
        self.actions.move_to_element(self.find_element(locator, timeout)).perform()
