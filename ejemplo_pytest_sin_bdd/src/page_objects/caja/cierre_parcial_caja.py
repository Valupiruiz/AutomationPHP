...
class CierreParcialCajaPage(DefaultPage):

    def __init__(self, driver, validar_pantalla):
        self._ingresar_montos = IngresarMontosPageElement(self, TiposOperacion.CierreParcial, TiposOperable.Caja)
        self._modal_confirmar = ModalConfirmarMontosPageElement(self, TiposOperacion.CierreParcial, TiposOperable.Caja)
        super().__init__(driver, validar_pantalla)
        self.wait_for_url('/cajas/operaciones/cierre-parcial')
